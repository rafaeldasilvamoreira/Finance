        ...
        <div className="bg-[#f4f4f4]  h-screen flex items-center justify-between">
            ...
            <div className="max-w-2xl mx-auto bg-white rounded-md" >
                <div className='flex flex-col items-center p-4'>
                    <h1 className="text-2xl text-[#09293D] font-bold">Faça Login</h1>
                    ...
                    <div className='flex justify-between gap-2 mt-2'>
                        <button className="text-center text-sm font-semibold">Esqueceu a senha?</button>
                        <Link to='../register'><button className="text-center text-sm font-semibold">Cadastre-se</button></Link>
                    </div>
                </div>
                {users.map(user => (
